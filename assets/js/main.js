...
var init = function init() {
  ...
  if (document.querySelector('.photo') !== null) {
    ...
    var backButton = document.querySelector('#post-photo footer'),
        contentImg = document.querySelector('#content-img img'),
        bgImg = document.querySelector('#bg-img img');

    contentImg.addEventListener('contextmenu', function (e) {
      alert("Plase, don't! - \xA9 Bal\xE1zs Orb\xE1n - Thank you!", e.clientX, e.clientY);
      e.preventDefault();
    });
    if (iW < 768) {
  ...
  if (document.querySelectorAll('header').length !== 0) {
    var menuElements = document.querySelectorAll('a span');
