...
export function NowPlaying() {
  ...
  return (
    <div className="flex flex-row-reverse sm:flex-row mb-8 space-x-0 sm:space-x-2 justify-center items-center">
      ...
      <div className="inline-flex flex-col sm:flex-row w-full max-w-full truncate items-center">
        {data?.songUrl ? (
          <a
            className="text-gray-400 p-1 font-medium max-w-xs truncate focus:outline-none focus:ring-4 focus:ring-main/50 ring-inset focus:border-transparent"
            href={data.songUrl}
            target="_blank"
