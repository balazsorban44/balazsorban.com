...
Despite delivering auth at scale for so many users, we are a small team, working on this project in our _free-time_! If you or your company benefit from our work, you could consier supporting us financially at our [OpenCollective page](https://opencollective.com/nextauth). Join amazing companies like [Vercel](https://vercel.com), [Prisma](https://prisma.io) and [Clerk](https://clerk.dev). We are grateful for one-time contributions, but you starring the repo or answering a fellow community member's question is also deeply appreciated. <Emoji label="green heart">💚</Emoji>
