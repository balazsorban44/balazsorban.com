...
Now let me tell you, this is not how I've always felt about open-source. It took me becoming the maintainer of a project with 2 million downloads a month(!) to understand and empathize with other maintainers on a whole different level. If you want to go away from this post with some wisdom, let me share a comment I read recently that just hit so well with me:

<Quote>
  A good reminder to always take the high road, you never know what someone is
  going through and why they’re taking their anger out on you". You have to
  understand, that behind every project, there is a face, a human being with
  their own personal story. Remember that, whenever you share a comment.
  Negative feedback is fine, but it _never_ has to be personal or insulting.
</Quote>
